...
| Mockup | [../../mockups/WM-RPT-08.html](../../mockups/WM-RPT-08.html) · canvas artboard `WM-RPT-08.dc.html` |

## Mục đích

Thực lãnh, thưởng, ứng, giảm trừ theo kỳ và theo tài xế; xuất bảng lương/phiếu lương.
...
| Xuất phiếu lương | payroll.export (admin, accountant) |

## Điều hướng đi (outgoing)

| Trigger | Đích | Route đích | Loại |
|---|---|---|---|
| Mở chi tiết bảng lương | [WM-PAYROLL-02](../wm/WM-PAYROLL-02.md) Chi tiết bảng lương | `/payroll/:payrollId` | action |
| Mở tài xế | [WM-DRV-02](../wm/WM-DRV-02.md) Chi tiết tài xế | `/drivers/:driverId` | action |
| Xuất phiếu lương tài xế | [WM-SHELL-05](../wm/WM-SHELL-05.md) Export/print preview | `(page) …/export · …/print` | action |
| Mở bảng lương kỳ 09 | [WM-PAYROLL-02](../wm/WM-PAYROLL-02.md) Chi tiết bảng lương | `/payroll/:payrollId` | action |
| Xuất phiếu lương hàng loạt | [WM-SHELL-05](../wm/WM-SHELL-05.md) Export/print preview | `(page) …/export · …/print` | action |
...
| Từ | Trigger |
|---|---|
| [WM-PAYROLL-01](../wm/WM-PAYROLL-01.md) Danh sách bảng lương | Mở báo cáo bảng lương |
| [WM-RPT-01](../wm/WM-RPT-01.md) Trung tâm báo cáo | Mở báo cáo Báo cáo bảng lương |
...
- `reportPayroll(filter{year, status, driverId})`
