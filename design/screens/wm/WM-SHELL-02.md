...
|---|---|---|---|
| Thông báo gần trùng lịch → cảnh báo lịch | WM-DISPATCH-03 | | action |
| Thông báo COD vượt ngưỡng → COD tài xế | WM-COD-01 | | action |
| Thông báo bảng lương chờ duyệt → bảng lương | WM-PAYROLL-02 | | action |
| Thông báo nợ quá hạn → công nợ khách | WM-CUS-05 | | action |
| Thông báo sự cố → chi tiết sự cố | WM-INC-01 | | action |
...
| Cài đặt ngưỡng cảnh báo | WM-SET-01 | | action |
